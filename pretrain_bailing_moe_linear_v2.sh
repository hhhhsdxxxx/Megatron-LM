...
#
# This script implements the complete training configuration for BailingMoE Linear V2
# See docs/plans/2026-03-08-bailing-moe-linear-v2-training-design.md for details
...
FLASH_LINEAR_PATH="${FLASH_LINEAR_PATH:-/path/to/flash-linear-attention}"
